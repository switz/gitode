    ...
    async.series([
        ...
        function(cb) {
            ...
            git(repoDir, ['reset', '--hard'], function(err, stdout, stderr) {
                ...
                cb(err, {reset: {stdout: stdout, stderr: stderr}});
            });
        },
        ...
        function(cb) {
            ...
            git(repoDir, ['checkout', '--', '.'], function(err, stdout, stderr) {
                ...
                cb(err, {checkout: {stdout: stdout, stderr: stderr}});
            });
        },
        ...
        function(cb) {
            ...
            git(repoDir, ['clean', '-d', '-f'], function(err, stdout, stderr) {
                ...
                cb(err, {clean: {stdout: stdout, stderr: stderr}});
            });
        },
        ...
        function(cb) {
            ...
            git(repoDir, ['fetch', 'origin'], function(err, stdout, stderr) {
                ...
                cb(err, {fetch: {stdout: stdout, stderr: stderr}})
            });
        },
        // Pull.
        function(cb) {
...
GitSync.prototype.pruneOrigin = function(dir, callback) {
  ...
  git(dir, ['remote','prune','origin'], function(err, stdout, stderr) {
    if (err) {
      callback({ msg: 'unable to prune against origin from ' + dir, err: err, stdout: stdout, stderr: stderr });
      return;
    }
